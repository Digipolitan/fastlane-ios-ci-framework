# Contributing to Digipolitan fastlane-ios-ci-framework
...
* **Did the problem start happening recently** (e.g. after updating to a new version of fastlane-ios-ci-framework) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of fastlane-ios-ci-framework ?** What's the most recent version in which the problem doesn't happen? You can download older versions of fastlane-ios-ci-framework from [the releases page](https://github.com/digipolitan/fastlane-ios-ci-framework/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of fastlane-ios-ci-framework are you using?
...
#### Template For Submitting Bug Reports
    ...
    **fastlane-ios-ci-framework version:** [Enter fastlane-ios-ci-framework version here]
    ...
    * Problem started happening recently, didn't happen in an older version of fastlane-ios-ci-framework: [Yes/No]
