# Contributing to Digipolitan Fastlane iOS Travis framework
...
* **Did the problem start happening recently** (e.g. after updating to a new version of Fastlane-ios-travis-framework) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of Fastlane-ios-travis-framework ?** What's the most recent version in which the problem doesn't happen? You can download older versions of Fastlane-ios-travis-framework from [the releases page](https://github.com/digipolitan/fastlane-ios-travis-framework/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of Fastlane-ios-travis-framework are you using?
...
#### Template For Submitting Bug Reports
    ...
    **Fastlane-ios-travis-framework version:** [Enter Fastlane-ios-travis-framework version here]
    ...
    * Problem started happening recently, didn't happen in an older version of Fastlane-ios-travis-framework: [Yes/No]
